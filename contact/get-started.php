...
if(isset($_POST['submit'])){
    ...
    <tr style='background: #eee;'><td colspan='2'><strong>Studentity - Early Access</strong> </td></tr>
    <tr>
    ...
    <tr>
        ...
        <td>".$_POST['university_name']."</td>
    </tr>
    <tr>
        <td><strong>Student Email:</strong></td>
        <td>".$_POST['student_email']."</td>
    </tr>
	</table>
	</body>
	</html>";
	
	$subject = "Studentity - Early Access";
